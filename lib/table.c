...
/* 0xA0 */	{ immediate, ldy },    { indirect_x, lda },   { immediate, ldx },    { NULL, NULL },
/* 0xA4 */	{ zero_page, ldy },    { zero_page, lda },    { zero_page, ldx },    { NULL, NULL },
/* 0xA8 */	{ NULL, NULL },        { immediate, lda },    { NULL, NULL },        { NULL, NULL },
/* 0xAC */	{ absolute, ldy },     { absolute, lda },     { absolute, ldx },     { NULL, NULL },
/* 0xB0 */	{ NULL, NULL },        { indirect_y, lda },   { NULL, NULL },        { NULL, NULL },
/* 0xB4 */	{ zero_page_x, ldy },  { zero_page_x, lda },  { zero_page_y, ldx },  { NULL, NULL },
/* 0xB8 */	{ NULL, NULL },        { absolute_y, lda },   { NULL, NULL },        { NULL, NULL },
/* 0xBC */	{ absolute_x, ldy },   { absolute_x, lda },   { absolute_y, ldx },   { NULL, NULL },

...
static void debug_acc(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X       %s%s A                           A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 1,
		cpu->instruction,
		instruction->undocumented ? "*" : " ",
		instruction->name,
...
static void debug_imm(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s #$%02X                        A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
...
static void debug_rel(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s $%04X                       A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 1),
		instruction->undocumented ? "*" : " ",
...
static void debug_zpa(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s $%02X = %02X                    A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu->operand_low,
		instruction->undocumented ? "*" : " ",
...
static void debug_zpx(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s $%02X,X @ %02X = %02X             A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 1),
		instruction->undocumented ? "*" : " ",
...
static void debug_zpy(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s $%02X,Y @ %02X = %02X             A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 1),
		instruction->undocumented ? "*" : " ",
...
static void debug_abj(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X %02X %s%s $%04X                       A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
...
static void debug_abo(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X %02X %s%s $%04X = %02X                  A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 3,
		cpu->instruction,
		cpu->operand_low,
		cpu->operand_high,
...
static void debug_abx(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X %02X %s%s $%04X,X @ %04X = %02X         A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 3,
		cpu->instruction,
...
static void debug_aby(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X %02X %s%s $%04X,Y @ %04X = %02X         A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 3,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 2),
		cpu_peek(cpu, cpu->program_counter - 1),
...
static void debug_ind(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X %02X %s%s ($%04X) = %04X              A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 3,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 2),
		cpu_peek(cpu, cpu->program_counter - 1),
...
static void debug_iix(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s ($%02X,X) @ %02X = %04X = %02X    A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 1),
		instruction->undocumented ? "*" : " ",
...
static void debug_iiy(struct cpu *cpu, struct instruction *instruction) {
	printf(
		"%04X  %02X %02X    %s%s ($%02X),Y = %04X @ %04X = %02X  A:%02X X:%02X Y:%02X P:%02X SP:%02X CYC:%lu\n",
		cpu->program_counter - 2,
		cpu->instruction,
		cpu_peek(cpu, cpu->program_counter - 1),
		instruction->undocumented ? "*" : " ",
